...
const styles = {
  ...
  brandLogo: {
    ...
    display: "grid",
    placeItems: "center",
    background: "linear-gradient(135deg, var(--accent-plum), var(--accent-primary))",
    fontSize: 20,
  },
  ...
  listItemActive: {
    background: "linear-gradient(135deg, rgba(0, 102, 80, 0.25), rgba(45, 27, 54, 0.15))",
  ...
  userBubble: {
    background: "linear-gradient(135deg, rgba(0, 102, 80, 0.35), rgba(45, 27, 54, 0.15))",
    border: "1px solid rgba(0, 102, 80, 0.35)",
    borderBottom: "2px solid rgba(0, 102, 80, 0.45)",
  },
  aiBubble: {
    background: "linear-gradient(135deg, rgba(19, 25, 36, 0.9), rgba(11, 14, 20, 0.95))",
    border: "1px solid rgba(255,255,255,0.06)",
  ...
  confirmBtn: { background: "linear-gradient(135deg, var(--accent-primary), var(--accent-plum))", color: "#fff" },
  toastContainer: {
    position: "fixed",
    top: 20,
    right: 20,
